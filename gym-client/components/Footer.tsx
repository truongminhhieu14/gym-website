      ...
      <div className="container mx-auto pb-24">
        ...
        >
          ...
          <motion.div variants={footerItem} className="flex flex-col gap-4">
            ...
            <p className="max-w-sm">City gym center thank you</p>
            <ul className="flex flex-col gap-4">
              <li className="flex items-center gap-4">
                <FaMapMarkedAlt className="text-xl text-accent" />
                <span>Dang Nhu Mai, Da Nang</span>
              </li>
              <li className="flex items-center gap-4">
                <FaPhoneAlt className="text-xl text-accent" />
                <span>+84 899611284</span>
              </li>
              <li>
                <Link className="flex items-center gap-4" href="#">
                  <FaEnvelope className="text-xl text-accent" />
                  <span>hieu1409033@gmail.com</span>
                </Link>
              </li>
            </ul>
          </motion.div>
          ...
          <motion.div variants={footerItem}>
            ...
            <div className="flex flex-wrap gap-2">
              <Link href="#">
                <Image
                  src={"/assets/assets/img/trainers/tramanh.jpg"}
                  width={100}
                  height={100}
                  alt=""
                />
              ...
              <Link href="#">
                <Image
                  src={"/assets/assets/img/trainers/phuonganh.jpg"}
                  width={100}
                  height={100}
                  alt=""
                />
              ...
              <Link href="#">
                <Image
                  src={"/assets/assets/img/trainers/minhmanh.jpg"}
                  width={100}
                  height={100}
                  alt=""
                />
              ...
              <Link href="#">
                <Image
                  src={"/assets/assets/img/trainers/david.jpg"}
                  width={100}
                  height={100}
                  alt=""
                />
              ...
              <Link href="#">
                <Image
                  src={"/assets/assets/img/trainers/rosy.jpg"}
                  width={100}
                  height={100}
                  alt=""
                />
              ...
              <Link href="#">
                <Image
                  src={"/assets/assets/img/trainers/matt.jpg"}
                  width={100}
                  height={100}
                  alt=""
                />
              ...
              <Link href="#">
                <Image
                  src={"/assets/assets/img/trainers/sofia.jpg"}
                  width={100}
                  height={100}
                  alt=""
                />
          ...
          <motion.div variants={footerItem}>
            ...
            <div className="flex flex-col gap-4">
              <p>
                Quickly leave your information below to receive offers and
                advice from The City Fitness experts.
              </p>
              <form className="flex items-center">
                ...
                />
                <CustomButton containerStyles="h-[50] px-8" text="Send" />
              </form>
            </div>
          </motion.div>
        </motion.div>
      ...
      <div className="text-white border-t border-white/20 py-12">
        <div className="container mx-auto h-full">
          <div className="flex items-center justify-between h-full">
            <span>&copy; Copyright 2025 The City Fitness</span>
